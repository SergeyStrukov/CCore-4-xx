     ...
     if( +args )
       {
        ...
        E.applyForSynt( [=,this] (Synt synt) { collector.append_fill(cur,synt.getIndex(),args); } );
          ...
          for(;;)
            {
             ...
             F.applyForSynt( [=,this] (Synt synt) { collector.append_fill(cur,synt.getIndex(),E,args); } );
