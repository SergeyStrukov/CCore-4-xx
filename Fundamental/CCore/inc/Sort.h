...
concept ObjLessFuncType = FuncType<Func,bool,Meta::ToConst<T> &,Meta::ToConst<T> &> ;

/* concept RanLessFuncType<Func,Ran> */

template <class Func,class Ran>
concept RanLessFuncType = ObjLessFuncType<Func,Meta::PtrObjType<Ran> > ;
...
void Sort(PtrLen<OpLessType auto> range) { Sort(range.ptr,range.len); }
