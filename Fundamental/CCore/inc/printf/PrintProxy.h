...
template <class T>
concept Has_PrintOptType = requires()
 {
...
template <class T>
concept No_PrintOptType = !Has_PrintOptType<T> ;

/* concept Has_PrintProxyType<T> */

template <class T>
concept Has_PrintProxyType = requires()
 {
...
template <class T>
concept No_PrintProxyType = !Has_PrintProxyType<T> ;
